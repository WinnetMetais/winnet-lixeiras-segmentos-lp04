...
const solutions = [
  { name: "Lixeiras Aro", image: lixeiraRedondaImg, application: "Lobbies, recepções e áreas nobres", benefitVisual: "Design clean que integra sem poluir", benefitFunc: "Tampa basculante e fácil higienização" },
  ...
  { name: "Lixeiras com Pedal", image: lixeiraPedalCozinhaImg, application: "Cozinhas, copas e áreas de serviço", benefitVisual: "Acabamento profissional e discreto", benefitFunc: "Acionamento higiênico sem contato" },
  { name: "Lixeira Inox com Tampa", image: lixeiraQuadradaImg, application: "Banheiros, suítes e spas", benefitVisual: "Elegância compacta para ambientes íntimos", benefitFunc: "Resistente à umidade e fácil limpeza" },
...
export const Solutions = () => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // Cards with stagger and slight rotation
      gsap.fromTo(
        ".sol-card",
  ...
  return (
    <section ref={ref} id="solucoes" className="py-24 lg:py-32 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="sol-grid grid sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto" style={{ perspective: "1000px" }}>
          {solutions.map((sol, i) => (
            <div
              key={i}
              className="sol-card group bg-card border border-border rounded-2xl overflow-hidden opacity-0 hover:shadow-xl transition-all duration-500 hover:-translate-y-2"
            >
        ...
        <div className="text-center mt-14">
          <Button
            size="lg"
            className="bg-accent hover:bg-accent/90 text-accent-foreground font-body font-semibold px-10 py-6 rounded-xl shadow-lg shadow-accent/20 hover:shadow-xl hover:shadow-accent/30 transition-all duration-300 hover:-translate-y-0.5"
